...
public class AddFriendPane extends JFrame {
	 ...
	 * Create the frame.
	 */
	public AddFriendPane(FriendListPane flu, ChatClient cc) {
		this.flu = flu;
		// 设置无标题栏
		setUndecorated(true);
		Figures.afu = this;
		...
		btnRegister.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					else if (Integer.parseInt(Friend_ID.getText().toString())==Figures.IDNum){
						JOptionPane.showMessageDialog(null, "好友不能是自己", "Error", JOptionPane.ERROR_MESSAGE);
					}
					else{
						cc.SendaddFriend(Integer.parseInt(Friend_ID.getText().toString()), list_name.getText().toString());
